           ...
           <i class="fa  bg-grey"><b>2</b></i>
              ...
              <div class="timeline-item">
                ...
                <h3 class="timeline-header no-border"><a href="#">HOW TO</a> deleted tugas </h3>
                  <div class="timeline-body">
                  Untuk mendelete tugas status harus available <a class="btn btn-success btn-flat btn-xs">Available</a>
                </div>
              </div>
            </li>
            <!-- END timeline item -->
          ...
          <ul class="timeline">
            ...
            <li>
              ...
              <div class="timeline-item">
                ...
                <h3 class="timeline-header"><a href="#">HOW TO </a> use TASK</h3>
           ...
           <i class="fa  bg-grey"><b>2</b></i>
              ...
              <div class="timeline-item">
                ...
                <h3 class="timeline-header no-border"><a href="#">HOW TO</a> deleted tugas </h3>
                  <div class="timeline-body">
                  Untuk mengerkjakan tugas silahkan masuk ke sisni <a class="btn btn-primary btn-flat btn-xs">kerjakan</a>
                </div>
              </div>
            </li>
            <!-- END timeline item -->
